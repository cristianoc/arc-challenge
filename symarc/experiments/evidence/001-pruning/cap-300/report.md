...
| random-order | 0.47 | 3.74 | 0.02 | 17.80 | 4.00 | 3.00 |
...
Shared preparation (enumeration, functionality prefilter, cached program answers): 2.36 s. Each policy/seed batch uses 12 workers and is run separately. Charged work covers program-grid checks, not closure construction; actual work is not assumed equal merely because the ceilings match.
...
| be94b721 | 2 | random-order | 121 → 26 | 2.22 | 1.15 → 0.00 | true | true | false | false | `cropLargest` |
