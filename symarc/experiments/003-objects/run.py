#!/usr/bin/env python3
"""Serial, bounded, reproducible object abstraction experiment; solver emits report directly."""
import datetime
import hashlib
import json
import os
...
exp = Path('experiments/003-objects')
...
try:
    ...
    dest = Path('out/experiments/003-objects') / (stamp+'-'+mode)
    dest.mkdir(parents=True)
    binary = exp/'target/release/symarc-exp-003-objects'
