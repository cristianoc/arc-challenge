...
Public training tasks only; pilot; 24 real tasks, 64 controlled cases; 12 workers. Core and 003 object language unchanged. Primary real-task search and saving: 0.28s; total including depth-3 audit and constructed cases: 0.29s. Resource measurements are in stderr.txt.

## Real-task coverage

| Arm | Training-fit tasks | Task exact match | Test-grid exact match | Prediction coverage (grids) | Accuracy given fit | Oracle tasks |
|---|---:|---:|---:|---:|---:|---:|
| grid + 003 objects | 4/24 (16.67%) | 2/24 (8.33%) | 2/25 (8.00%) | 4/25 (16.00%) | 2/4 (50.00%) | 3/24 (12.50%) |
| relations only | 0/24 (0.00%) | 0/24 (0.00%) | 0/25 (0.00%) | 0/25 (0.00%) | n/a | 0/24 (0.00%) |
| control then relations fallback | 4/24 (16.67%) | 2/24 (8.33%) | 2/25 (8.00%) | 4/25 (16.00%) | 2/4 (50.00%) | 3/24 (12.50%) |
...
Relations add 0 training-fitting tasks and 0 oracle-correct tasks beyond the control. Candidate ASTs checked: 398376; actual training program/example checks: 398376. Candidate counts are syntax, not unique semantics or equivalent operation costs.
